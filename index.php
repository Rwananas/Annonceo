    ...
    <div class="row my-5">
        ...
        <div class="col-md-2">
            ...
            <?php while($menuCategorie = $afficheMenuCategories->fetch(PDO::FETCH_ASSOC)): ?>
                <a class="btn btn-outline-success my-2" href="<?= URL ?>?categorie=<?= $menuCategorie['id_categorie'] ?>"><?= $menuCategorie['titre'] ?></a>
            <?php endwhile; ?>
            </div>
            ...
            <div class="row justify-content-around text-center">
                ...
                <div class="card mx-3 shadow p-3 mb-5 bg-white rounded" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="fiche_produit.php?id_produit=<?= $produit['id_annonce'] ?>" class="btn btn-outline-success"><i class='bi bi-search'></i> Voir Produit</a>
                    </div>
                </div>
                <?php endwhile; ?>
            </div>
